...
const TrendingMovies = () => {
  ...
  return (
    <div className="my-10 w-11/12 mx-auto px-10">
      ...
      >
          ...
          <div className="w-64 bg-gray-800 rounded-lg shadow-lg flex-shrink-0 relative">
            <img
            ...
            <div className="p-4">
              ...
              <span className="text-xs absolute top-0 right-1 mt-2 text-white bg-red-500 px-2 py-1 rounded-full">
                Trending Now
              </span>
            </div>
          </div>
